...
public class QrDecodeServiceImpl implements QrDecodeService {
    ...
    @Override
    public DecodeQrDTO decode(File image) throws IOException, FormatException, ChecksumException, NotFoundException {
        return decode(ImageIO.read(image));
    }

    @Override
    public DecodeQrDTO decode(InputStream imageInputStream) throws IOException, FormatException, ChecksumException, NotFoundException {
        return decode(ImageIO.read(imageInputStream));
    }

    private DecodeQrDTO decode(final BufferedImage bufferedImage) throws FormatException, ChecksumException, NotFoundException {
